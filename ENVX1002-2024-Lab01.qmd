...
- Download and open the file **Code_Topic1.r** from canvas or if you are accessing HTML on GitHub use this link [r code](./Code_Topic1.r) and you will see most of the commands you have been typing.  Rather than typing commands into R we will now start to use RStudio.  
